        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4">
              Your digital gateway to knowledge. Manage your library experience 
              with ease and discover new worlds through books.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li><a href="/my-books" className="hover:text-white transition-colors">My Books</a></li>
